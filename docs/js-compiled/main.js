...
var author$project$Http$Boxed$NotRequested = {$: 'NotRequested'};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{httpBoxedJson: author$project$Http$Boxed$NotRequested, httpBoxedText: author$project$Http$Boxed$NotRequested, httpUrl: ''},
...
var author$project$Http$Boxed$Fetching = {$: 'Fetching'};
var author$project$Http$Boxed$BadPayload = F2(
	function (a, b) {
		return {$: 'BadPayload', a: a, b: b};
	});
var author$project$Http$Boxed$BadStatusGoodPayload = function (a) {
	return {$: 'BadStatusGoodPayload', a: a};
};
var author$project$Http$Boxed$Error = function (a) {
	return {$: 'Error', a: a};
};
var author$project$Http$Boxed$Success = function (a) {
	return {$: 'Success', a: a};
};
var elm$core$Basics$ge = _Utils_ge;
var author$project$Http$Boxed$codeIsSuccess = function (code) {
	return (200 >= code) && (code < 300);
};
var author$project$Http$Boxed$BadStatus = function (a) {
	return {$: 'BadStatus', a: a};
};
var author$project$Http$Boxed$BadUrl = function (a) {
	return {$: 'BadUrl', a: a};
};
var author$project$Http$Boxed$NetworkError = {$: 'NetworkError'};
var author$project$Http$Boxed$Timeout = {$: 'Timeout'};
var author$project$Http$Boxed$convertHttpErrorinBoxedError = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var string = error.a;
			return author$project$Http$Boxed$BadUrl(string);
		case 'Timeout':
			return author$project$Http$Boxed$Timeout;
		case 'NetworkError':
			return author$project$Http$Boxed$NetworkError;
		case 'BadStatus':
			var response = error.a;
			return author$project$Http$Boxed$BadStatus(response);
		default:
			var string = error.a;
			var response = error.b;
			return A2(author$project$Http$Boxed$BadPayload, string, response);
	}
};
var elm$json$Json$Decode$decodeString = _Json_runOnString;
var author$project$Http$Boxed$fromResponseExpectingJson = F2(
	function (response, decoderBody) {
		if (response.$ === 'Err') {
			var err = response.a;
			return author$project$Http$Boxed$Error(
				author$project$Http$Boxed$convertHttpErrorinBoxedError(err));
		} else {
			var res = response.a;
			var _n1 = A2(elm$json$Json$Decode$decodeString, decoderBody, res.body);
			if (_n1.$ === 'Err') {
				var err = _n1.a;
				return author$project$Http$Boxed$Error(
					A2(
						author$project$Http$Boxed$BadPayload,
						elm$json$Json$Decode$errorToString(err),
						res));
			} else {
				var b = _n1.a;
				var resNew = {body: b, headers: res.headers, status: res.status, url: res.url};
				return author$project$Http$Boxed$codeIsSuccess(res.status.code) ? author$project$Http$Boxed$Success(resNew) : author$project$Http$Boxed$Error(
					author$project$Http$Boxed$BadStatusGoodPayload(resNew));
			}
		}
	});
var author$project$Http$Boxed$fromResponseExpectingString = function (response) {
	if (response.$ === 'Err') {
		var err = response.a;
		return author$project$Http$Boxed$Error(
			author$project$Http$Boxed$convertHttpErrorinBoxedError(err));
		...
		var res = response.a;
		return author$project$Http$Boxed$codeIsSuccess(res.status.code) ? author$project$Http$Boxed$Success(res) : author$project$Http$Boxed$Error(
			author$project$Http$Boxed$BadStatusGoodPayload(res));
	}
};
...
var author$project$Http$Boxed$HttpStatus = F2(
	function (code, message) {
		return {code: code, message: message};
	});
var elm$http$Http$Response = F4(
	function (url, status, headers, body) {
		...
		A3(
			...
			A3(
				...
				A3(
					...
					elm$json$Json$Decode$succeed(author$project$Http$Boxed$HttpStatus))),
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'url',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(elm$http$Http$Response)))));
var author$project$Http$Boxed$unboxResponse = function (outerResponse) {
	var _n0 = A2(elm$json$Json$Decode$decodeString, author$project$Http$Boxed$decodeResponse, outerResponse.body);
	if (_n0.$ === 'Ok') {
		var innerResponse = _n0.a;
		return elm$core$Result$Ok(innerResponse);
	} else {
		return elm$core$Result$Ok(outerResponse);
	}
};
var author$project$Main$NewGifExpectingJson = function (a) {
	return {$: 'NewGifExpectingJson', a: a};
};
var author$project$Main$NewGifExpectingText = function (a) {
	return {$: 'NewGifExpectingText', a: a};
};
...
var author$project$Main$getRandomGif = F2(
	function (url, expectingJson) {
		return A2(
			lukewestby$elm_http_builder$HttpBuilder$send,
			expectingJson ? author$project$Main$NewGifExpectingJson : author$project$Main$NewGifExpectingText,
			A2(
				lukewestby$elm_http_builder$HttpBuilder$withExpect,
				elm$http$Http$expectStringResponse(author$project$Http$Boxed$unboxResponse),
		...
		switch (msg.$) {
			case 'MorePlease':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{httpBoxedJson: author$project$Http$Boxed$Fetching, httpBoxedText: author$project$Http$Boxed$Fetching, httpUrl: url}),
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2(author$project$Main$getRandomGif, url, true),
								A2(author$project$Main$getRandomGif, url, false)
							])));
			case 'MsgFetching':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{httpBoxedJson: author$project$Http$Boxed$Fetching, httpBoxedText: author$project$Http$Boxed$Fetching, httpUrl: ''}),
					elm$core$Platform$Cmd$none);
			case 'MsgNotRequested':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{httpBoxedJson: author$project$Http$Boxed$NotRequested, httpBoxedText: author$project$Http$Boxed$NotRequested, httpUrl: ''}),
					elm$core$Platform$Cmd$none);
			case 'NewGifExpectingJson':
				var result = msg.a;
				var httpBoxedJson = A2(author$project$Http$Boxed$fromResponseExpectingJson, result, author$project$Main$decoderBodyResponse);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var result = msg.a;
				var httpBoxedText = author$project$Http$Boxed$fromResponseExpectingString(result);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Http$Boxed$body = function (boxed) {
	switch (boxed.$) {
		case 'Success':
			var response = boxed.a;
			return elm$core$Maybe$Just(response.body);
		case 'Error':
			var error = boxed.a;
			if (error.$ === 'BadStatusGoodPayload') {
				var response = error.a;
				return elm$core$Maybe$Just(response.body);
			} else {
				return elm$core$Maybe$Nothing;
...
var author$project$Http$Boxed$headers = function (boxed) {
	switch (boxed.$) {
		case 'Success':
			var response = boxed.a;
			return elm$core$Maybe$Just(response.headers);
		case 'Error':
			var error = boxed.a;
			switch (error.$) {
				case 'BadPayload':
...
var author$project$Http$Boxed$status = function (boxed) {
	switch (boxed.$) {
		case 'Success':
			var response = boxed.a;
			return elm$core$Maybe$Just(response.status.code);
		case 'Error':
			var error = boxed.a;
			switch (error.$) {
				case 'BadPayload':
...
var author$project$Http$Boxed$encodeResponse = function (record) {
				...
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'code',
							elm$json$Json$Encode$int(record.status.code)),
							_Utils_Tuple2(
							'message',
							elm$json$Json$Encode$string(record.status.message))
						]))),
				_Utils_Tuple2(
				'headers',
				A3(elm$json$Json$Encode$dict, elm$core$Basics$identity, elm$json$Json$Encode$string, record.headers)),
				_Utils_Tuple2(
				'body',
				elm$json$Json$Encode$string('N/A'))
			]));
};
var author$project$Http$Boxed$toString = function (boxed) {
	switch (boxed.$) {
		case 'NotRequested':
			return 'NotRequested';
		case 'Fetching':
		...
		case 'Success':
			...
			return 'Success\n\n' + A2(
				...
				4,
				author$project$Http$Boxed$encodeResponse(response));
		default:
			var error = boxed.a;
	...
	function (model, type_, msg, description) {
		return A2(
			...
			_Utils_ap(
				author$project$Main$buttonAttributes,
				_Utils_ap(
					_Utils_eq(model.httpBoxedJson, type_) ? _List_fromArray(
						[
							A2(elm$html$Html$Attributes$style, 'background-color', '#aaaaff')
						]) : _List_Nil,
					_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Click the buttons below for usage examples.')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						A3(author$project$Main$viewButton, model, 'api-tests/boxed409.json', '409'),
						A3(author$project$Main$viewButton, model, 'api-tests/boxed409EmptyJson.json', '\"{}\" 409'),
						A3(author$project$Main$viewButton, model, 'api-tests/boxed409EmptyString.json', '\"\" 409'),
						A3(author$project$Main$viewButton, model, 'api-tests/boxed409Headers.json', '409 Headers')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						A4(author$project$Main$viewButton2, model, author$project$Http$Boxed$NotRequested, author$project$Main$MsgNotRequested, 'Not Requested'),
						A4(author$project$Main$viewButton2, model, author$project$Http$Boxed$Fetching, author$project$Main$MsgFetching, 'Fetching')
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('model.httpUrl')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				...
				_List_fromArray(
					[
						elm$html$Html$text('Http.Boxed.toString')
					])),
				A2(
				elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Json: ' + author$project$Http$Boxed$toString(model.httpBoxedJson))
					])),
				A2(
				elm$html$Html$pre,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Text: ' + author$project$Http$Boxed$toString(model.httpBoxedText))
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Http.Boxed.status')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Json: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$status(model.httpBoxedJson)))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Text: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$status(model.httpBoxedText)))
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Http.Boxed.headers')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Json: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$headers(model.httpBoxedJson)))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Text: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$headers(model.httpBoxedText)))
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Http.Boxed.body')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Json: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$body(model.httpBoxedJson)))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Text: ' + elm$core$Debug$toString(
							author$project$Http$Boxed$body(model.httpBoxedText)))
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Debug.toString')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Json: ' + elm$core$Debug$toString(model.httpBoxedJson))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Text: ' + elm$core$Debug$toString(model.httpBoxedText))
					]))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"MorePlease":["String.String"],"NewGifExpectingJson":["Result.Result Http.Error (Http.Response String.String)"],"NewGifExpectingText":["Result.Result Http.Error (Http.Response String.String)"],"MsgFetching":[],"MsgNotRequested":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));